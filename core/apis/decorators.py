...
def authenticate_principal(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        # else:
        #     assertions.assert_true(False, 'No such api')        ]
        """this error will handel in server.py. beacause authenticate_principal execute after blueprint route decoretor and blueprint throw error autometicly """
